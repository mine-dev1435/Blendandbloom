...
export default function LocationHero({ h1Text, hideCourses = false }) {
    ...
    <section id="home" className="relative min-h-screen flex items-end overflow-hidden" style={{ background: "var(--ink)" }}>
      ...
      <div className="relative container mx-auto px-6 pb-8 md:pb-12 pt-32 md:pt-[18vh] w-full z-20 flex flex-col min-h-screen justify-between">
        ...
        <div className="flex flex-col items-center text-center mt-2">
          ...
          <div
            className="serif uppercase leading-tight relative inline-block text-[28px] md:text-[60px]"
            style={{
              color: "var(--cream)",
              letterSpacing: "0.1em",
              opacity: loaded ? 1 : 0,
          ...
          >
            {hideCourses ? "Where Beauty Meets Expertise" : h1Text}
          </div>
        </div>
