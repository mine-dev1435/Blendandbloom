...
export const CLIENTS = [
  ...
  "/img/client_img4.jpeg",
  "/img/client_img3.jpeg",
  "/img/client_img2.jpeg",
  "/img/client_img6.jpeg",
  "/img/client_img5.jpeg",
  "/img/client_img1.jpeg",

];

export const PROGRAMS = [
  {
    title: "Master Professional Hair Styling",
    desc: "Learn modern cutting, coloring, and styling techniques through practical salon training",
    points: [
      "Hair Cutting Techniques",
      "Hair Coloring & Highlig",
      "Hair Spa & Hair Treatments",
      "Professional Hair Styling & Finishing",
             "100% Placement support",

    ],
    img: "/img/Hairstyling-course.jpeg",
  },
  {
    title: "Master Hair Extension Course",
    desc: "Master premium hair extension methods to create seamless, natural-looking.",
    points: [
      "Tape-in Extensions",
      "Keratin Bond Application",
      "Micro-Ring Extensions",
      "Seamless Blending & Styling",
             "100% Placement support",

    ],
    img: "/img/Hairextention-course.jpeg",
  },
  {
    title: "Professional Skin Care Course",
    desc: "Build expertise in advanced skincare treatments and professional facial therapies.",
    points: [
  ...
  },
  {
    ...
    desc: "Become a certified makeup artist with hands-on training in bridal and fashion makeup.",
    points: [
...
export const TEAM = [
  ...
  {
    name: "Flora",
    role: "Makeup Artist & Skin Care Trainer",
...
export const TESTIMONIALS = [
  {
    name: "Ariana Cole",
    role: "Editorial Makeup Graduate",
    quote: "The instructors treated technique like a craft, not a shortcut. I left with a portfolio and real client instincts.",
    img: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=200&q=80",
  },
  {
    name: "Priya Nair",
    role: "Hair Design Diploma",
    quote: "Every session ended with a live model. By week six I was cutting with a confidence I didn't expect so soon.",
    img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=200&q=80",
  },
  {
    name: "Devon Reyes",
    role: "Skin Therapy Track",
    quote: "Clinic hours made the difference. I was consulting real clients before I even graduated the program.",
